...
export class AdvisorServiceBase {
  ...
  async count(args: Omit<Prisma.AdvisorCountArgs, "select">): Promise<number> {
  ...
  async advisors<T extends Prisma.AdvisorFindManyArgs>(
    ...
    return this.prisma.advisor.findMany<Prisma.AdvisorFindManyArgs>(args);
  }
