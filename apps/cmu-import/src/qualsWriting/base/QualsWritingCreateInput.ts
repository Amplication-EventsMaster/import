...
class QualsWritingCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => QualsWritingAspectCreateNestedManyWithoutQualsWritingsInput,
  })
  @ValidateNested()
  @Type(() => QualsWritingAspectCreateNestedManyWithoutQualsWritingsInput)
  @IsOptional()
  @Field(() => QualsWritingAspectCreateNestedManyWithoutQualsWritingsInput, {
    nullable: true,
  })
...
export { QualsWritingCreateInput as QualsWritingCreateInput };
