...
@InputType()
class StudentDatumCreateNestedManyWithoutUserRolesInput {
...
export { StudentDatumCreateNestedManyWithoutUserRolesInput as StudentDatumCreateNestedManyWithoutUserRolesInput };
