...
@InputType()
class EmploymentCreateNestedManyWithoutStudentDataInput {
...
export { EmploymentCreateNestedManyWithoutStudentDataInput as EmploymentCreateNestedManyWithoutStudentDataInput };
