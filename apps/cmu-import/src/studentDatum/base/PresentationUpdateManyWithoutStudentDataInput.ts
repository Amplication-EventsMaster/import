...
@InputType()
class PresentationUpdateManyWithoutStudentDataInput {
...
export { PresentationUpdateManyWithoutStudentDataInput as PresentationUpdateManyWithoutStudentDataInput };
