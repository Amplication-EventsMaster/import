...
@InputType()
class QualsCommitteeCreateNestedManyWithoutStudentDataInput {
...
export { QualsCommitteeCreateNestedManyWithoutStudentDataInput as QualsCommitteeCreateNestedManyWithoutStudentDataInput };
