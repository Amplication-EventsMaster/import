...
@InputType()
class InterviewCreateNestedManyWithoutStudentDataInput {
...
export { InterviewCreateNestedManyWithoutStudentDataInput as InterviewCreateNestedManyWithoutStudentDataInput };
