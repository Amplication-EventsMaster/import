...
@InputType()
class StudentDataMlCreateNestedManyWithoutStudentDataInput {
...
export { StudentDataMlCreateNestedManyWithoutStudentDataInput as StudentDataMlCreateNestedManyWithoutStudentDataInput };
