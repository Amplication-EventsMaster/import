...
@InputType()
class InternshipCreateNestedManyWithoutStudentDataInput {
...
export { InternshipCreateNestedManyWithoutStudentDataInput as InternshipCreateNestedManyWithoutStudentDataInput };
